// src/lib.rs
/*
 * Core library for AnimePercolator
 */
...
#[derive(Debug)]
pub struct AnimePercolatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimePercolatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimePercolator processing");
    
    let mut processor = AnimePercolatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimePercolatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimePercolatorProcessor::new(false);
